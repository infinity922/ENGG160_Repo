...
from .my_util import pin_list_to_board_dict, to_two_bytes, two_byte_iter_to_str
...
ENCODER = 9        # digital pin in ENCODER mode
...
class Board(object):
    ...
    def setup_layout(self, board_layout):
        ...
        # Setup ENCODER pins
        for i in board_layout['encoder']:
            self.digital[i].ENCODER_CAPABLE = True
    ...
    def _handle_encoder_data(self, direction, p1, p2, p3, p4):
        dire = direction >> 6
